      ...
      <div className="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white">
        <div className="text-center">
          <div className="inline-flex rounded-full bg-sky-100 p-4">
            <div className="rounded-full stroke-teal-600 bg-teal-200 p-4">
              <svg
                className="w-16 h-16"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <h1 className="mt-5 text-[36px] font-bold  text-teal-600 lg:text-[50px]">
            503 - Error del Servidor
          </h1>
          <p className="text-slate-600 mt-5 lg:text-lg">
            Algo salió mal. Intente actualizar esta página o <br /> si el
