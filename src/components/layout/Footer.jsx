  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mt-8 space-x-6">
          ...
          <a href="./huella.html" className="text-amber-100 hover:text-blue-700 cursor:pointer">
          ...
          <a href="https://github.com/Los-Chiperos" className="text-amber-100 hover:text-blue-700 cursor:pointer">
